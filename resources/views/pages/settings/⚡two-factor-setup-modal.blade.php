        ...
        <div class="flex flex-col items-center space-y-4">
            <div class="p-0.5 w-auto rounded-full border border-stone-100 dark:border-stone-600 bg-white dark:bg-stone-800 shadow-sm">
                <div class="p-2.5 rounded-full border border-stone-200 dark:border-stone-600 overflow-hidden bg-stone-100 dark:bg-stone-200 relative">
                    ...
                    <x-icon name="qr-code" class="relative z-20 size-6 text-gray-900 dark:text-white" />
                </div>
            </div>
        ...
        @if ($showVerificationStep)
            <div class="space-y-6">
                ...
                <div class="flex items-center gap-3">
                    <x-button outline class="flex-1" wire:click="resetVerification">
                        {{ __('Back') }}
                    </x-button>
                    ...
                    @else
                        <div class="flex items-center justify-center h-full p-4">
                            <div
                                ...
                                x-data
                                x-bind:style="document.documentElement.classList.contains('dark') ? 'filter: invert(1) brightness(1.5)' : ''"
                            >
                                {!! $qrCodeSvg !!}
                            </div>
                        </div>
                ...
                >
                    <div class="flex items-stretch w-full border rounded-xl dark:border-stone-700">
                        ...
                        @else
                            ...
                            >
                                <x-icon x-show="!copied" name="document-duplicate" class="size-5" outline />
                                <x-icon x-show="copied" name="check" class="size-5 text-green-500" />
                            </button>
                        @endempty
                    </div>
                </div>
